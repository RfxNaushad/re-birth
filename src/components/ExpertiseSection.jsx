...
//             className="card flex flex-col justify-between lg:flex-row space-y-4 lg:space-y-0 lg:items-start"
//           >
...
//         trigger: '#expertiseContainer',
//         start: 'top top',
//         end: '+=1000', // Adjust based on scroll length needed
//         pin: true,
//         scrub: true,
//       },
//     });
...
//         index * 0.5 // Adjust delay between each card stacking
//       );
//     });
//   }, []);
...
//             style={{ zIndex: index + 1 }} // Higher z-index for each successive card
//           >
//             <div className="flex w-[80%]">
//               <div className="flex flex-col gap-4 w-[70%]">
//                 <p className="text-gray-400 text-[1rem] uppercase">{item.id} —</p>
