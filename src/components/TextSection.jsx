...
function TextSection() {
  ...
  return (
    <section id="text-image" className="bg-black h-fit overflow-hidden relative py-20">
      ...
      <div
        ref={profileRef}
        className="profileSection absolute w-full bg-black  flex items-center justify-center transition-opacity duration-1000 ease-in-out"
      >
        <ProfileSection />
      </div>
    </section>
